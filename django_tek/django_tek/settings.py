"""
Django settings for django_tek project.
...
SECRET_KEY = '&cq%wy+*6uumy3rrek#tr8$9kt5ikj*_wgz*56q$2*z&-ar5(='
...
WSGI_APPLICATION = 'django_tek.wsgi.application'
